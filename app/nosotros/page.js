  ...
  return (
    <>
      <section className="relative flex min-h-[50vh] items-end overflow-hidden">
        <Image
          src={IMAGES.greenhouseRows.src}
          alt={IMAGES.greenhouseRows.alt}
          fill
          priority
          sizes="100vw"
      ...
      <section className="relative overflow-hidden bg-papaya text-forest">
        ...
        <div className="relative mx-auto max-w-3xl px-6 py-20">
          ...
          <p className="mt-6 max-w-[65ch] leading-relaxed text-forest/85 font-body">
          ...
          <div className="mt-12 grid gap-8 sm:grid-cols-3">
            {PILLARS.map((pillar, i) => (
              <Reveal key={pillar.title} delay={i * 0.08}>
                <h3 className="font-heading text-sm uppercase tracking-wide text-army">
                  {pillar.title}
                </h3>
                <p className="mt-2 text-sm leading-relaxed text-forest/75 font-body">
                  {pillar.text}
                </p>
              </Reveal>
            ))}
